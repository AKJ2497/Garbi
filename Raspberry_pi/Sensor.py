...
while 1==1:
	try:
		...
		if connflag == True:
			...
			motion = digitalRead(pir_sensor)
			temp_value = random.randint(20,120)   #Simulated temperature for worst case situation
			hum_value = random.randint(0,100)      #Simulated Humidity for worst case situation
