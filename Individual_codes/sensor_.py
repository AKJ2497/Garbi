...
#Fire and Air quality alert to be done by AI PLANNING
		...
		if temp_value >= 100:
			alert = "Fire in the Garbi Plant: EMERGENCY, RUN FOR YOUR LIFE!"
			print(alert) #publish directly to dashboard
			setRGB(0,128,64)
			setRGB(255,0,0)
		...
		if airquality >= 50:
			alert = "Bad Air Quality in the Garbi Plant: EMERGENCY, WEAR MASK"
			print(alert) #publish directly to dashboard
			setRGB(0,128,64)
			setRGB(150,127,0)
...
#Untill here
		...
		paylodmsg5= ", \"Alert\":"
		paylodmsg6= "}"
		paylodmsg = "{} {} {} {} {} {} {} {} {} {} {} {}".format(paylodmsg0, paylodmsg1, dt_string, paylodmsg2, temp_value, paylodmsg3, hum_value, paylodmsg4, airquality, paylodmsg5, alert, paylodmsg6)
